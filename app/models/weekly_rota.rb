class WeeklyRota < ActiveRecord::Base
	...
	def build_7_shift_templates_belonging_to!(partner_name)
		time_template = DateTime.parse("Sun, 01 Jan 2006 09:00:00 UTC +00:00")
		7.times do |i|
			self.shift_templates.build(:name => partner_name, :start_at => time_template + i, :end_at => time_template + i + 8.hours)
		end
	end
end
