...
################################################################################################################################################
Competency.create([{:name => 'Camera', :priority => 2}, {:name => 'Audio', :priority => 2}, {:name => 'Television',:priority => 2}, {:name => 'Computer',:priority => 2}, {:name => 'Telephone',:priority => 2}, {:name => 'Task Team',:priority => 1}, {:name => 'Sasu',:priority => 1}])
